...
public class UserDto
{
    ...
    @XmlTransient
    public SimpleLongProperty dinero;//este
    @XmlTransient
    public SimpleLongProperty esmeralda;//este
    @XmlTransient
    ...
    public UserDto(User user)
    {
        ...
        this.dinero.set(user.getUserDinero());//este
        this.esmeralda.set(user.getUserEsmeraldas());//este
    ...
    public void setEsmeralda(Long esmeralda)
    {
    ...
    {
        if(lvlFuerza.get() != null && !lvlFuerza.get().isEmpty())
        {
