...
public class UserDto
{
    ...
    @XmlTransient
    private SimpleStringProperty lvl;
    @XmlTransient
    private SimpleStringProperty imgUser;
    @XmlTransient
    private SimpleStringProperty imgBallesta;
    @XmlTransient
    private SimpleStringProperty imbCastillo;
    @XmlTransient
    private SimpleStringProperty dinero;
    @XmlTransient
    private SimpleStringProperty esmeralda;
    @XmlTransient
    private SimpleStringProperty mVida;
    @XmlTransient
    private SimpleStringProperty mMana;
    @XmlTransient
    private SimpleStringProperty lvlFuerza;
    @XmlTransient
    private SimpleStringProperty lvlAgilidad;
    @XmlTransient
    private SimpleStringProperty lvlRetroceso;
    @XmlTransient
    private SimpleStringProperty lvlDDamage;
    @XmlTransient
    private SimpleStringProperty lvlTiroDoble;
    @XmlTransient
    private SimpleStringProperty lvlFireBall;
    @XmlTransient
    private SimpleStringProperty lvlFreeze;
    @XmlTransient
    private SimpleStringProperty lvlRayo;
