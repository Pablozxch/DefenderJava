...
public class UserService
{
    ...
    public Respuesta obtenerTodo()
    {
        try
        {
            ...
            return new Respuesta(true , "" , "" , "Users" , UserDto);
        }
        catch(NoResultException ex)
        {
            return new Respuesta(false , "No existen empleados con los criterios ingresados." , "getUsers NoResultException");
        }
        catch(Exception ex)
        {
            Logger.getLogger(UserService.class.getName()).log(Level.SEVERE , "Error obteniendo empleados." , ex);
            return new Respuesta(false , "Error obteniendo empleados." , "getUsers " + ex.getMessage());
        }
    }
